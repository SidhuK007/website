...
export default function ArrowAnimation() {
  ...
  useGSAP(() => {
    ...
    tl.to("#banner-arrow-svg", { autoAlpha: 1, duration: 0.1 })
      .to(".svg-arrow", { duration: 2, delay: 1, strokeDashoffset: 0 })
      .to("#banner-arrow-svg", { duration: 0.5, delay: 0.5, fill: "#ffffff08" })
      .to("#banner-arrow-svg", { duration: 1, y: 300 })
      .to("#banner-arrow-svg", { duration: 0, autoAlpha: 0 });
  });
